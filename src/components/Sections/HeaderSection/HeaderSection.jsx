  ...
  return (
    <section className="bg-gradient-to-br from-blue-50 via-white to-yellow-50 py-16 px-4 sm:px-6 lg:px-8 min-h-[80vh] flex items-center overflow-hidden relative">
      ...
      >
        ...
        <motion.div
          className="absolute top-1/2 left-1/4 text-green-200"
          animate={floatingAnimation}
        >
          ...
          <div>
            ...
            <motion.ul className="space-y-6 text-gray-600 mb-8" variants={containerVariants}>
              ...
              >
                ...
                <span className="text-lg">Nasza wieloletnia współpraca z klientami pozwala nam na przemyślane i elastyczne poszerzanie oferty zarówno produktowej jak i usługowej.</span>
              </motion.li>
              <motion.li 
                className="flex items-start"
                variants={itemVariants}
            ...
            <motion.div variants={itemVariants}>
              <motion.button 
                className="inline-flex items-center px-8 py-4 border border-transparent text-lg font-bold rounded-full text-white bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-lg"
