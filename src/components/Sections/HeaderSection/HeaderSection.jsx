	...
	const sections = [
		{
			title: 'Doświadczenie',
			icon: Circle,
			content: 'Działając od 1997 roku, wnosimy dekady doświadczenia branżowego do każdego projektu.',
		},
		{
			title: 'Elastyczność',
			icon: Square,
			content: 'Nasze usługi dostosowują się do Twoich potrzeb, obejmując zarówno produkty, jak i obszary usług.',
		},
		{
			title: 'Wydajność',
			icon: Triangle,
			content: 'Optymalizujemy zarządzanie zasobami, zapewniając maksymalną wartość dla naszych kontrahentów.',
		},
	]
			...
			<header className='flex-grow flex flex-col md:flex-row'>
				<div className='md:w-1/2 p-6 md:p-12 flex flex-col justify-center bg-white'>
					...
					<p className='text-gray-600 mb-8'>
						Zanurz się w świat innowacyjnych rozwiązań dostosowanych do Twojego sukcesu.
					</p>
