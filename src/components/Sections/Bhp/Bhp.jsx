          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                "Usługi nadzoru i doradztwa z nadrukiem.",
        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          <div className="flex justify-center items-center space-x-4">
            {['helmet', 'goggles', 'vest', 'boots', 'gloves', 'suit'].map((item) => (
              <div key={item} className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center transform hover:scale-105 transition-transform duration-200">
                <Image 
                  src={`icons/${item}.svg`} 
                  alt={item} 
                  width={40} 
