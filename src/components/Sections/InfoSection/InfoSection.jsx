        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              Zamówione produkty dostarczamy na miejsce do siedziby Odbiorcy
              transportem własnym lub za pośrednictwem firm kurierskich.
            </p>
            <button className="w-full mt-4 bg-blue-600 text-white p-2 rounded-lg shadow-lg">
              SPRAWDŹ NASZYCH DOSTAWCÓW
            </button>
          </div>
