...
export default function PersonnelDepartment() {
	...
	return (
		<section id='personal' className='container mx-auto px-4 py-8 max-w-4xl'>
			<h1 className='text-4xl text-gray-600 font-bold mb-8 text-center'>DZIAŁ PERSONALNY</h1>

			<div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-start'>
				<div className='space-y-4'>
					<p className='font-semibold'>
						Dostarczamy paczki okolicznościowe, upominki dla pracowników, owoce, ciasta, lody.
					</p>
				...
				<div className='relative '>
					<Image src='/images/8.jpg' alt='Personnel department image' width={600} height={400} className='rounded-lg' />
				</div>
			</div>

			<div className='mt-4 h-6 bgcyan w-full'></div>
